...
class open_the_laptop_screen(SimpleEnv):
    ...
    def _compute_reward(self):
        ...
        screen_pos = get_link_state(self, "Laptop", "link_0")
        ...
        # The reward is the negative distance between the current joint angle and the joint angle when the screen is fully open (upper limit).
...
gym.register(
    id='gym-open_the_laptop_screen-v0',
    entry_point=open_the_laptop_screen,
)
