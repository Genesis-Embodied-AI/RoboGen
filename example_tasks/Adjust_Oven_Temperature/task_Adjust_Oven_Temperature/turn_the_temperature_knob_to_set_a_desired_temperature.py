...
class turn_the_temperature_knob_to_set_a_desired_temperature(SimpleEnv):
    ...
    def _compute_reward(self):
        ...
        knob_pos = get_link_state(self, "Oven", "link_1")
        reward_near = -np.linalg.norm(eef_pos - knob_pos)
        
        joint_angle = get_joint_state(self, "Oven", "joint_1") 
        
        joint_limit_low, joint_limit_high = get_joint_limit(self, "Oven", "joint_1")
...
gym.register(
    id='gym-turn_the_temperature_knob_to_set_a_desired_temperature-v0',
    entry_point=turn_the_temperature_knob_to_set_a_desired_temperature,
)
