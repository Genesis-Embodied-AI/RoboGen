...
class turn_the_timer_knob_to_set_a_desired_cooking_time(SimpleEnv):
    ...
    def _compute_reward(self):
        ...
        desired_time = joint_limit_low + (joint_limit_high - joint_limit_low)  / 2 # We assume the target desired time is half of the joint angle. It can also be 1/3, or other values between joint_limit_low and joint_limit_high. 
...
gym.register(
    id='gym-turn_the_timer_knob_to_set_a_desired_cooking_time-v0',
    entry_point=turn_the_timer_knob_to_set_a_desired_cooking_time,
)
