...
class close_the_oven_door(SimpleEnv):
    ...
    def _compute_reward(self):
        ...
        # The reward is the negative distance between the current joint angle and the joint angle when the door is fully closed (lower limit).
...
gym.register(
    id='gym-close_the_oven_door-v0',
    entry_point=close_the_oven_door,
)
