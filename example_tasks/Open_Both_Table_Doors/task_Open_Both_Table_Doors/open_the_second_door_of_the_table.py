...
class open_the_second_door_of_the_table(SimpleEnv):
    ...
    def _compute_reward(self):
        ...
        door_pos = get_link_state(self, "Table", "link_1")
        reward_near = -np.linalg.norm(eef_pos - door_pos)
        
        # Get the joint state of the second door. 
        joint_angle = get_joint_state(self, "Table", "joint_1") 
        ...
        joint_limit_low, joint_limit_high = get_joint_limit(self, "Table", "joint_1")
...
gym.register(
    id='gym-open_the_second_door_of_the_table-v0',
    entry_point=open_the_second_door_of_the_table,
)
