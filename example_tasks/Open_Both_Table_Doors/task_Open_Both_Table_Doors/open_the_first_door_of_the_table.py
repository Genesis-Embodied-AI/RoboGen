...
class open_the_first_door_of_the_table(SimpleEnv):
    ...
    def _compute_reward(self):
        ...
        door_pos = get_link_state(self, "Table", "link_0")
        reward_near = -np.linalg.norm(eef_pos - door_pos)
        
        # Get the joint state of the first door. 
...
gym.register(
    id='gym-open_the_first_door_of_the_table-v0',
    entry_point=open_the_first_door_of_the_table,
)
