...
class open_the_door_of_the_storage_furniture(SimpleEnv):
...
gym.register(
    id='gym-open_the_door_of_the_storage_furniture-v0',
    entry_point=open_the_door_of_the_storage_furniture,
)
