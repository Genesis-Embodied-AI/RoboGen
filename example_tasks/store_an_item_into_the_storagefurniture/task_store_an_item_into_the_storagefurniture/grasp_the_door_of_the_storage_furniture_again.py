...
class grasp_the_door_of_the_storage_furniture_again(SimpleEnv):
...
gym.register(
    id='grasp_the_door_of_the_storage_furniture_again-v0',
    entry_point=grasp_the_door_of_the_storage_furniture_again,
)
