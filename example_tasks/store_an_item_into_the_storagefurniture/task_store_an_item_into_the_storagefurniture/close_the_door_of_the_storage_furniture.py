...
class close_the_door_of_the_storage_furniture(SimpleEnv):
...
gym.register(
    id='gym-close_the_door_of_the_storage_furniture-v0',
    entry_point=close_the_door_of_the_storage_furniture,
)
