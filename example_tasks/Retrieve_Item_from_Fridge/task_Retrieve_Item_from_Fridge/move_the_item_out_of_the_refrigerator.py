...
class move_the_item_out_of_the_refrigerator(SimpleEnv):
    ...
    def _compute_reward(self):
        ...
        # The goal is not to just move the item to be at a random location out of the refrigerator. Instead, we need to place it somewhere on the table. 
...
gym.register(
    id='gym-move_the_item_out_of_the_refrigerator-v0',
    entry_point=move_the_item_out_of_the_refrigerator,
)
